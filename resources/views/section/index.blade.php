                                ...
                                @can('create')
                                    <button type="button" class="btn add-new btn-primary ms-2 mb-sm-0 crud" data-action="create" data-id="0" data-bs-target="#crud-modal" data-bs-toggle="modal">
                                        <span>
                                            ...
                                            <span class="d-none d-lg-inline-block">{{ __('بخش جدید') }}</span>
                                        </span>
                                    </button>
                                @endcan
                            </div>
...
@section('footer-scripts')
    ...
    let table = `<div class="table-responsive">
        ...
        $(document).ready(function() {
            ...
            $(document.body).on("click", "#store-section", function() {
                var e = checkEmpty();
                if (!e) {
                    $("#loading").fadeIn();
                    var name = $("#name").val();
            ...
            $(document.body).on("click", ".update-default-section", function() {
                $("#loading").fadeIn();
                var id = $(this).data('id');
                var status = $(this).is(':checked');
                $.ajax({
                    type: "POST",
                    url: "{{ route('updateDefaultSection') }}",
                    data: {
                        id: id,
                        status: status
                    },
