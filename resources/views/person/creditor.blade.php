                    ...
                    <div class="card-header border-bottom">
                        <div class="py-3 primary-font">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">@lang('از مبلغ طلب')</label>
                                        <input type="text" id="s-from-price" class="form-control just-numbers"
                                            placeholder="@lang('از مبلغ طلب')...">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">@lang('تا مبلغ طلب')</label>
                                        <input type="text" id="s-to-price" class="form-control just-numbers"
                                            placeholder="@lang('تا مبلغ طلب')...">
                                    </div>
                                </div>
                                <div class="col-md-3 d-flex align-items-end justify-content-start">
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('creditorPerson') }}" class="btn btn-info" id="show-all">
                                            @lang('نمایش همه')
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="col">
                        <div
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                <div class="btn-group">
                                    <button id="export" disabled class="btn btn-success">
                                        <span>
            ...
            $(document.body).on("click", ".remove-debt", function() {
                ...
                if (action == 'all') {
                    Swal.fire({
                        ...
                        text: "@lang('طلب تمام کاربران، بدون ثبت سند منفی صفر میشود.')",
                        icon: "warning",
